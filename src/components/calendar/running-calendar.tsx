...
export default function RunningCalendar({
  ...
  const tileClassName: CalendarProps['tileClassName'] = ({ date, view }) => {
    ...
    if (date.getMonth() !== month) {
      return 'flex flex-col justify-between items-center relative min-h-[45px] p-2 rounded-lg text-center text-sm font-light text-gray-200'
    }

    const classes: string[] = [
      'flex flex-col justify-between items-center relative p-2 min-h-[45px] rounded-lg text-center text-sm font-light',
    ]
